...
public interface Repository {
    ...
    Optional<Category> getCategoryByName(String name) throws Exception;
    int createCategory(Category category) throws Exception;
    void updateCategory(Category category) throws Exception;
    void deleteCategory(int id) throws Exception;
    void removeCategoryAssignments(int id) throws Exception;
    ...
    void assignCategoryToArticle(int categoryId, int articleId) throws Exception;
    void unassignCategoryFromArticle(int categoryId, int articleId) throws Exception;
